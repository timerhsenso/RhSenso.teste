...
using RhS.SEG.Core.Abstractions.Crud;

// PageQuery/PageResult – ajuste o using conforme o seu Shared.
// Se seus tipos estiverem em "RhS.SharedKernel", troque a linha abaixo.
using RhS.SharedKernel.Paging;

namespace RhS.Api.Common.Controllers
{
    /// <summary>
