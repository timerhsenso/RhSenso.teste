...
using RhS.SEG.Core.Abstractions.SEG.Botoes;
using RhS.SEG.Core.Entities;
using RhS.Infrastructure.Data; // <<< aqui

namespace RhS.Infrastructure.Services.SEG.Botoes // se usar uma pasta Services/SEG/Botoes
{
    public sealed class BotoesService : IBotoesService
    {
        private readonly RhSensoDbContext _db;                     // <<< aqui
        public BotoesService(RhSensoDbContext db) => _db = db;     // <<< aqui
