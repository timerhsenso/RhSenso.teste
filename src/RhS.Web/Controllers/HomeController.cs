...
namespace RhS.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> DebugPerms1([FromServices] RhS.Web.Services.Security.IPermissionProvider prov)
        {
